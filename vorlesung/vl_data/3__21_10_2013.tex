...
\definition{}
Eine Formelmenge $\Sigma$ \Index{impliziert semantisch} eine Formel $H$, falls für jedes Modell $f$ von $\Sigma$ gilt $f(H) = W$; d.h. $f$ ist auch Modell von $\{H\}$. Wir schreiben $\Sigma \models H$. Ist $\Sigma = \{G\}$ so schreiben wir auch $G \models H $ für $G$ impliziert semantisch $H$.
...
\satz{1.7} \textbf{\Index{Gaig'scher Interpolationssatz}}\\
